...
//Spricht direkt zur Datenbank
public class H2MovieRepository {
    ...
    public List<Movie> findAll() throws DatabaseException {
        ...
        try (Connection connection = DatabaseUtil.getConnection();
            ...
            while (resultSet.next()) {
                //Neu: "MovieFactory" wurde hinzugefügt, damit das Pattern benutzt wird
                MovieFactory movieFactory = new MovieFactory();

                Movie movie = movieFactory.createMovie(        // Creates again the Java Object
...
/*
Altes MovieRepository wurde zu "H2MovieRepository" umbenannt, da sich dieses Repo nur noch um die
H2 Datenbank kümmert.
*/
